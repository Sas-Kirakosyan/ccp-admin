...
import { lastBidColumns } from './BidTableColumn';
...
export const LastBidTableModal = observer(({ toggle }) => {
  const { lastBidLoading } = issuancesStore;

  const handlePopupAdjustBid = () => {
    uiStore.toggleModal('adjustBid');
  };
